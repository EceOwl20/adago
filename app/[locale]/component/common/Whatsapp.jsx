...
const Whatsapp = () => {
  ...
  const phoneNumber = '+90 532 562 77 77';
  ...
  return (
    <div className='fixed bottom-2 left-5 lg:left-5 right-5 z-[9999] flex h-[85px] items-center md:bottom-4 bg-transparent justify-between'>
      <div className='flex lg:hidden bottom-0 h-[60px] w-[60px] inset-0 items-center justify-center shadow rounded-md z-[90] bg-slate-200 '>
      <button onClick={openWhatsApp} className='flex'>
