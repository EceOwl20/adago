    ...
    <div className='flex flex-row w-full text-white '>
      <div className='flex w-full shrink-0 bg-royalBlue overflow-y-auto shadow shadow-darkSeaBlue items-center justify-around p-2'>
        <div className='flex text-[15px] lg:text-[18px] xl:text-[20px] font-montserrat font-semibold items-center gap-20'>
            ...
            <Link className="hover:bg-white hover:text-darkSeaBlue p-1 rounded-md" href="/villa1">Odalar</Link>
            <Link className="hover:bg-white hover:text-darkSeaBlue p-1 rounded-md" href="/floorPlan" >Kat Planı</Link>
            <Link className="hover:bg-white hover:text-darkSeaBlue p-1 rounded-md" href="/layoutPlan" >Vaziyet Planı</Link>
        </div>
      </div>
    </div>
  )
